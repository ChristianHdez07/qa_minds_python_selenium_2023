...
1. Abra la página https://demo.seleniumeasy.com/bootstrap-alert-messages-demo.html
    a. Presione en la opción Autoclaseable success message
    b. Verificar que se muestre mensaje
    c. Verificar que mensaje mostrado desaparece después de 5 segundos
"""
...
class TestLandingPage:
    ...
    def test_slow_loading_page(self):
        ...
        self.__wait_until_disappears(By.XPATH, "//div[@class='alert alert-success alert-autocloseable-success']")
