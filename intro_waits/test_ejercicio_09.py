"""
Ejercicio #09
1. Construir un test que:
    a. Abra la página https://demo.seleniumeasy.com/jquery-download-progress-bar-demo.html
    b. Verificar que aparece el mensaje: Complete
    c. Verificar que aparece el botón Close
"""
...
class TestLandingPage:
    ...
    def test_slow_loading_page(self):
        ...
        button_download = self.__find_clickable_element(By.ID, "downloadButton")
        button_download.click()
        self.__find_by_text(By.CLASS_NAME, "progress-label", "Complete!")
        self.__find_by_text(By.XPATH, "//div[@class= 'ui-dialog-buttonset']//button", "Close")
